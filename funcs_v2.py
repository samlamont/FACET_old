...
class workerfuncs():  # QtCore.QObject

#    def __init__(self, parent=None):   
#        
#        super(workerfuncs, self).__init__(parent)
    ...
    def read_xns_shp_and_get_dem_window(self, str_xns_path, str_dem_path):    
    ...
    # ===================================================================================
    def write_xns_shp(self, df_coords, streamlines_crs, str_xns_path, bool_isvalley, p_xngap, p_fitlength, p_xnlength):
        """
...
#                    print('pause')
    ...
    # ===================================================================================
    def get_stream_coords_from_features(self, str_streams_filepath, cell_size, str_reachid, str_orderid):
